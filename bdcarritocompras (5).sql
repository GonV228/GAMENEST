...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-05-2024 a las 16:01:14
...
CREATE TABLE `detallecompra` (
  ...
  `idJuego` int(11) UNSIGNED NOT NULL,
...
INSERT INTO `reclamaciones` (`id`, `nombre`, `apellidos`, `correo`, `telefono`, `producto`, `monto_reclamado`, `descripcion_problema`, `evidencia`, `idCliente`) VALUES
(1, 'sfsfa', 'asffsgds', 'asasd@gmail.com', '46456456', 'afsafsafsegrg', 152.00, 'jtfyf', '', 0),
(2, 'sfsfafghf', 'asffsgdsfgjfgj', 'asasd@gmail.com', '4645645645', 'afsafsafsegrg', 152.00, 'buuÃ±', 'Captura de pantalla 2024-05-25 160148.png', 0),
(3, 'sfsfafghf', 'asffsgdsfgjfgj', 'asasd@gmail.com', '4645645645', 'afsafsafsegrg', 152.00, 'tjrhtherhrhe', 'PERFIL.png', 0);
...
--
ALTER TABLE `juego`
  MODIFY `idJuego` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
...
--
ALTER TABLE `compras`
  ADD CONSTRAINT `compras_idCliente_users` FOREIGN KEY (`idCliente`) REFERENCES `usuario` (`idCliente`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `detallecompra`
--
ALTER TABLE `detallecompra`
  ADD CONSTRAINT `detallecompra_idCompra_users` FOREIGN KEY (`idCompra`) REFERENCES `compras` (`idCompra`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `detallecompra_idJuego_users` FOREIGN KEY (`idJuego`) REFERENCES `juego` (`idJuego`) ON DELETE NO ACTION ON UPDATE NO ACTION;
